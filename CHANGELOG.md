...
## [12/05/2026] - Dashboard: Top khách hàng chỉ hiển thị tên
### Fixed
- **Dashboard** — Bảng “Top khách hàng theo doanh số (tháng này)” cột khách hàng chỉ hiển thị tên, không hiển thị số điện thoại. — File: `src/pages/Dashboard.tsx`
