-- 018_021_multi_shop_bundle.sql
-- Gộp các migration: 018_multi_shop + 019_super_admin + 020_shop_valid_until + 021_role_permissions_role_id
-- Dùng cho DB cũ (trước multi-shop) để chạy 1 lần.
--
-- CẢNH BÁO:
-- - Chạy trên DB đã chạy một phần migration có thể báo lỗi cột/index đã tồn tại.
